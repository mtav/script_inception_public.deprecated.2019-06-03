...
bl_info = {
    'name': 'Import bfdtd DXF Format (.dxf)',
    'author': 'Thomas Larsson, Remigiusz Fiedler',
    'version': (0, 1, 6),
    'blender': (2, 6, 3),
    'location': 'File > Import > bfdtd (.dxf)',
    'description': 'Import files in the bfdtd DXF format (.dxf)',
...
class IMPORT_OT_bfdtd_dxf(bpy.types.Operator):
...
def menu_func(self, context):
    self.layout.operator(IMPORT_OT_bfdtd_dxf.bl_idname, text="bfdtd (.dxf)")
