...
def loncar_cylinder(BASENAME = 'loncar_structure', DSTDIR = uigetdir(getuserdir(),'DSTDIR'), ITERATIONS, print_holes_top, print_holes_bottom, HOLE_TYPE=1, pillar_radius_mum = 0.150/2.0, EXCITATION_FREQUENCY = get_c0()/637*10^-3, SNAPSHOTS_FREQUENCY,excitation_type):
      #%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      # description:
...
def main(argv=None):
  ...
  try:
    ...
    # more code, unchanged
    print('hello')
    #loncar_cylinder('test_python', getenv('TESTDIR'), 32000, 1, 1, 1, 0.150/2.0, get_c0()/0.637, [get_c0()/0.637, get_c0()/0.637-1, get_c0()/0.637+1],1)
