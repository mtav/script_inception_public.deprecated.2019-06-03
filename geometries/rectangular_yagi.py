...
def main(argv=None):
  ...
  parser.add_option("--radius_Z_piercer_mum", type="float", dest="radius_Z_piercer_mum", default=0.100, help="radius_Z_piercer_mum")
  parser.add_option("--baseName", type="string", dest="baseName", default=default_basename, help="baseName")
