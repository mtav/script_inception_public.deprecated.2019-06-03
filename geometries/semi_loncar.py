...
def semi_loncar(DSTDIR,BASENAME,pos,exc):
  ...
  cylinder1 = copy(cylinder)
  cylinder2 = copy(cylinder)
  cylinder3 = copy(cylinder)
  
  pillar.geometry_object_list.append(block)
  pillar.geometry_object_list.append(cylinder1)
  pillar.geometry_object_list.append(cylinder2)
  pillar.geometry_object_list.append(cylinder3)
...
if __name__ == "__main__":
  ...
  #for pos in range(5):
    #for exc in range(4):
      #semi_loncar(DSTDIR,'semi_loncar_'+str(pos)+'_'+str(exc),pos,exc)
  pos=4
  exc=2
  semi_loncar('semi_loncar_'+str(pos)+'_'+str(exc),pos,exc)
