function micropillar(RADIUS, DSTDIR, BASENAME, N_TYPE, BOTTOM_N, TOP_N, FREQUENCY, SNAPSHOTS_ON, ITERATIONS)
	...
	H = [ 0, 0,	0];
	type = 10;
	GEOexcitation(out, 7, P1, P2, E, H, type, TIME_CONSTANT, AMPLITUDE, TIME_OFFSET, EXCITATION_FREQUENCY, 0, 0, 0, 0);
	...
	GEOtime_snapshot(out, first, repetition, 1, P1_SNAPSHOT_BOX, P2_SNAPSHOT_BOX, E, H, J, power);
