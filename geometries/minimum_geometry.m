function minimum_geometry(BASENAME, DSTDIR, Nx_frequency_snapshot,Ny_frequency_snapshot,Nz_frequency_snapshot,Nx_time_snapshot,Ny_time_snapshot,Nz_time_snapshot,N_probes)
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	%description:
	% creates a minimum geometry
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
