% case 4
function g_Hz = coupling_strength(tau_s,w_Hz,n,V_m3)
    % calculations
    a_nm = 1;
...
% case 1
function g_Hz = coupling_strength(n, lambda_nm, K1, tau_ns)
    % calculations
    a_nm = 1;
    % lambda_nm = a_nm ./ a_over_lambda;
    lambda_m = 10^-9*lambda_nm;
...
% case 3
function g_Hz = coupling_strength_3(a_nm, a_over_lambda, n, V_mum3, tau_ns)
    % calculations
    lambda_nm = a_nm ./ a_over_lambda;
    lambda_m = 10^-9*lambda_nm;
    tau_s = 10^-9*tau_ns;
...
% case 2
function g_Hz = coupling_strength_2(mu_Debye,lambda_nm,K1,V_mum3)
    % calculations
    lambda_m = 10^-9*lambda_nm;
    V_m3 = (10^-6)^3*V_mum3;
    w_Hz = 2*pi*get_c0()./lambda_m;
