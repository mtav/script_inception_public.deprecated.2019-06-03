function automax = plotSnapshotSum(snapshot_filename, column, maxval, handles, rotate90, hide_figures, imageSaveName)
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  automax = 8./9.*max(data)+1./9.*mean(data);
  if isnan(maxval)
    %maxval = max(data);
