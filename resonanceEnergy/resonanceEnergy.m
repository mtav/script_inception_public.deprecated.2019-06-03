function [ E_meV, lambda_nm, real_neff, radius_vector_mum, E_vector_meV, lambda_vector_nm, real_neff_vector, u, v, b, v_cutoff ] = resonanceEnergy(n_cavity, n_mirror, n_outside, Lcav_nm, radius, L, M)
